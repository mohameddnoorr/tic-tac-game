...
class Game {
  ...
  Future<void> autoPlay(activePlayer) async {
    ...
    //vert
      ...
      index = 0;
    } else if (Player.playerO.containsAll(4, 1) && emptyCells.contains(7)) {
      index = 7;
    ...
    //cross
      ...
      index = 0;
    } else if (Player.playerO.containsAll(4, 2) && emptyCells.contains(6)) {
      index = 6;
    ...
    //vert
      ...
      index = 0;
    } else if (Player.playerX.containsAll(4, 1) && emptyCells.contains(7)) {
      index = 7;
    ...
    //cross
      ...
      index = 0;
    } else if (Player.playerX.containsAll(4, 2) && emptyCells.contains(6)) {
      index = 6;
